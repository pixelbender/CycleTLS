...
[![godoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://godoc.org/github.com/pixelbender/CycleTLS/cycletls/utls#UConn)
---
...
so you are encouraged to use [godoc](https://godoc.org/github.com/pixelbender/CycleTLS/cycletls/utls#UConn).
...
# Client Hello IDs
See full list of `clientHelloID` values [here](https://godoc.org/github.com/pixelbender/CycleTLS/cycletls/utls#ClientHelloID).  
...
1. Import this library (e.g. `import tls "github.com/pixelbender/CycleTLS/cycletls/utls"`)
