  ...
  child.stderr.on("data", (stderr) => {
    if (stderr.toString().includes("Request_Id_On_The_Left")) {
      ...
      debug
        ...
        : cleanExit(`Error Processing Request (please open an issue https://github.com/pixelbender/CycleTLS/issues/new/choose) -> ${stderr}`, false).then(() => handleSpawn(debug, fileName, port));
    }
  });
}
